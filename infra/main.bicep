...
param vmUserName string = 'azadmin'
...
module orchestrator './core/host/functions.bicep' = {
  ...
  params: {
    ...
    storageAccountName: 'stgorc${substring(uniqueString(guidValue), 0, 5)}'
    appServicePlanId: appServicePlan.outputs.id
...
module dataIngestion './core/host/functions.bicep' = {
  ...
  params: {
    ...
    vnetName: vnet.outputs.name
    networkIsolation: networkIsolation
    storageAccountName: 'stging${substring(uniqueString(guidValue), 0, 5)}'
